...
(function () {
  ...
  var T = {
    en: {
      ...
      "alb.2": "Maracanã: every stadium now has its own atmosphere scenes.",
      ...
      "alb.7": "Wall mode: old-school indoor football, the ball never goes out.",
    ...
    es: {
      ...
      "alb.2": "Maracaná: ahora todos los estadios tienen escenas de ambientación propias.",
      ...
      "alb.7": "Paredón: fútbol indoor de barrio, la pelota nunca sale.",
