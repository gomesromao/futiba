...
L["pt"] = dict(
    ...
    p6=dict(hd="INDOOR", big="FUTSAL E PAREDÃO.",
            ...
            setup=["Marque quem joga na linha com o botão de passe.",
                   "O <b>GL</b> (goleiro-linha) é o reserva que pode entrar no lugar do goleiro para atacar: escolha com o botão de chute. No toque, o jogo sugere o GL e o B volta.",
...
L["en"] = dict(
    ...
    p6=dict(hd="INDOOR", big="FUTSAL AND WALL MODE.",
            ...
            setup=["Mark who plays outfield with the pass button.",
                   "The <b>sweeper</b> (GL) is the substitute who can replace the goalkeeper to attack: pick him with the shoot button. On touch, the game suggests the sweeper and B goes back.",
...
L["es"] = dict(
    ...
    p6=dict(hd="INDOOR", big="FÚTSAL Y PAREDÓN.",
            ...
            setup=["Marcá quién juega de campo con el botón de pase.",
                   "El <b>portero-líbero</b> (POR-LÍBERO) es el suplente que puede entrar en lugar del arquero para atacar: elegilo con el botón de remate. En táctil, el juego sugiere el portero-líbero y B vuelve.",
